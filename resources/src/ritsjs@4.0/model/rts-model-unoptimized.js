...
function vector_9861232(v_9861235) {
  var result_9861236 = ({length: 0, data: null});
    ...
    result_9861236.data = new Float32Array(1012);
...
function HEX2EHEX2A_10060265(v_10060267, w_10060268) {
  var result_10060269 = [({length: 0, data: null})];
    ...
    result_10060269[0].data = new Float32Array(1012);
    L1: do {
      var i_10060281 = 0;
...
function HEX5BHEX5D_9965014(v_9965016, idx_9965024) {
  var result_9965025 = ({length: 0, data: null});
    ...
    result_9965025.data = new Float32Array(1012);
    var k_9965033 = 0;
    L1: do {
      var i_9965058 = 0;
      L2: do {
...
function HEX2D_10060167(v_10060169, k_10060170) {
  var result_10060171 = [({length: 0, data: null})];
    ...
    result_10060171[0].data = new Float32Array(1012);
    L1: do {
      var i_10060183 = 0;
...
function acf_10065110(x_10065112, max_lag_10065113) {
  var result_10065114 = [({length: 0, data: null})];
    ...
    result_10065114[0].data = new Float32Array(1012);
...
function collection_to_string_10091008(x_10091011, prefix_10091012, separator_10091013, suffix_10091014) {
  var result_10091015 = [null];

    result_10091015[0] = nimCopy(null, prefix_10091012, NTI112);
...
function HEX2D_10060136(v_10060138, w_10060139) {
  var result_10060140 = [({length: 0, data: null})];
    ...
    result_10060140[0].data = new Float32Array(1012);
    L1: do {
      var i_10060152 = 0;
      var colontmp__10120214 = 0;
      var colontmp__10120215 = 0;
      colontmp__10120214 = low_9885064(v_10060138);
      colontmp__10120215 = high_9885047(v_10060138);
      var res_10120216 = colontmp__10120214;
      L2: do {
          L3: while (true) {
          if (!(res_10120216 <= colontmp__10120215)) break L3;
            i_10060152 = res_10120216;
...
function HEX2B_10060051(v_10060053, k_10060054) {
  var result_10060055 = [({length: 0, data: null})];
    ...
    result_10060055[0].data = new Float32Array(1012);
    L1: do {
      var i_10060067 = 0;
      var colontmp__10120222 = 0;
      var colontmp__10120223 = 0;
      colontmp__10120222 = low_9885064(v_10060053);
      colontmp__10120223 = high_9885047(v_10060053);
      var res_10120224 = colontmp__10120222;
      L2: do {
          L3: while (true) {
          if (!(res_10120224 <= colontmp__10120223)) break L3;
            i_10060067 = res_10120224;
...
function HEX2EHEX2A_10060296(v_10060298, k_10060299) {
  var result_10060300 = [({length: 0, data: null})];
    ...
    result_10060300[0].data = new Float32Array(1012);
    L1: do {
      var i_10060312 = 0;
      var colontmp__10120230 = 0;
      var colontmp__10120231 = 0;
      colontmp__10120230 = low_9885064(v_10060298);
      colontmp__10120231 = high_9885047(v_10060298);
      var res_10120232 = colontmp__10120230;
      L2: do {
          L3: while (true) {
          if (!(res_10120232 <= colontmp__10120231)) break L3;
            i_10060312 = res_10120232;
...
function HEX2EHEX5E_10060703(v_10060705, k_10060706) {
  var result_10060707 = [({length: 0, data: null})];
    ...
    result_10060707[0].data = new Float32Array(1012);
    L1: do {
      var i_10060719 = 0;
      var colontmp__10120238 = 0;
      var colontmp__10120239 = 0;
      colontmp__10120238 = low_9885064(v_10060705);
      colontmp__10120239 = high_9885047(v_10060705);
      var res_10120240 = colontmp__10120238;
      L2: do {
          L3: while (true) {
          if (!(res_10120240 <= colontmp__10120239)) break L3;
            i_10060719 = res_10120240;
...
function simple_linear_regression(x_10120128, y_10120129) {
  var result_10120130 = ({intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: ({autocorrelation: null, confidence_interval: 0.0}), n: 0});

    var n_10120131 = len_9885030(x_10120128);
    var sx_10120132 = sum_10060935(x_10120128);
    var sxx_10120133 = sum_10060935(HEX2EHEX2A_10060265(x_10120128, x_10120128));
    var sy_10120134 = sum_10060935(y_10120129);
    var sxy_10120135 = sum_10060935(HEX2EHEX2A_10060265(x_10120128, y_10120129));
    var syy_10120136 = sum_10060935(HEX2EHEX2A_10060265(y_10120129, y_10120129));
    var t_value_10120137 = student_t_ppf_95p_10065058((n_10120131 - 2.0000000000000000e+000));
    result_10120130.n = ((n_10120131)|0);
    result_10120130.slope = (((n_10120131 * sxy_10120135) - (sx_10120132 * sy_10120134)) / (((n_10120131 * sxx_10120133) - HEX5E_10061056(sx_10120132, 2)) + 1.0000000000000000e-010));
    result_10120130.intercept = ((sy_10120134 / n_10120131) - ((result_10120130.slope * sx_10120132) / n_10120131));
    result_10120130.R2 = ((HEX5E_10061056(((n_10120131 * sxy_10120135) - (sx_10120132 * sy_10120134)), 2) / ((n_10120131 * sxx_10120133) - HEX5E_10061056(sx_10120132, 2))) / (((n_10120131 * syy_10120136) - HEX5E_10061056(sy_10120134, 2)) + 1.0000000000000000e-010));
    var residual_10120158 = HEX2D_10060136(y_10120129, HEX2B_10060082(result_10120130.intercept, HEX2A_10060399(result_10120130.slope, x_10120128)));
    result_10120130.residual = nimCopy(null, vector_to_seq_9910014(residual_10120158), NTI9910017);
    result_10120130.residual_sum_squares = sum_10060935(HEX2EHEX5E_10060703(residual_10120158, 2.0000000000000000e+000));
    result_10120130.residual_variance = ((((n_10120131 * syy_10120136) - HEX5E_10061056(sy_10120134, 2)) - (HEX5E_10061056(result_10120130.slope, 2) * ((n_10120131 * sxx_10120133) - HEX5E_10061056(sx_10120132, 2)))) / (((n_10120131 * n_10120131) - (2.0000000000000000e+000 * n_10120131)) + 1.0000000000000000e-010));
    nimCopy(result_10120130.autocorrelation_function, acf_information_10065170(residual_10120158, 100), NTI10065076);
    result_10120130.slope_variance = ((n_10120131 * result_10120130.residual_variance) / (((n_10120131 * sxx_10120133) - HEX5E_10061056(sx_10120132, 2)) + 1.0000000000000000e-010));
    result_10120130.intercept_variance = ((result_10120130.slope_variance * sxx_10120133) / n_10120131);
    result_10120130.slope_p_value = p_value_of_t_distr_10102061(result_10120130.slope, result_10120130.slope_variance, ((n_10120131)|0));
    result_10120130.intercept_p_value = p_value_of_t_distr_10102061(result_10120130.intercept, result_10120130.intercept_variance, ((n_10120131)|0));
    result_10120130.slope_width_confidence_interval = ((2.0000000000000000e+000 * Math.sqrt(result_10120130.slope_variance)) * t_value_10120137);
    result_10120130.slope_confidence_interval[0] = (result_10120130.slope - (5.0000000000000000e-001 * result_10120130.slope_width_confidence_interval));
    result_10120130.slope_confidence_interval[1] = (result_10120130.slope + (5.0000000000000000e-001 * result_10120130.slope_width_confidence_interval));
    result_10120130.intercept_width_confidence_interval = ((2.0000000000000000e+000 * Math.sqrt(result_10120130.intercept_variance)) * t_value_10120137);
    result_10120130.intercept_confidence_interval[0] = (result_10120130.intercept - (5.0000000000000000e-001 * result_10120130.intercept_width_confidence_interval));
    result_10120130.intercept_confidence_interval[1] = (result_10120130.intercept + (5.0000000000000000e-001 * result_10120130.intercept_width_confidence_interval));

  return result_10120130;

}
function simple_linear_regression_wo_intercept(x_10120252, y_10120253) {
  var result_10120254 = ({intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: ({autocorrelation: null, confidence_interval: 0.0}), n: 0});

    var n_10120255 = len_9885030(x_10120252);
    var sx_10120256 = sum_10060935(x_10120252);
    var sxx_10120257 = sum_10060935(HEX2EHEX2A_10060265(x_10120252, x_10120252));
    var sy_10120258 = sum_10060935(y_10120253);
    var sxy_10120259 = sum_10060935(HEX2EHEX2A_10060265(x_10120252, y_10120253));
    var sxxyy_10120260 = sum_10060935(HEX2EHEX2A_10060265(HEX2EHEX2A_10060265(x_10120252, y_10120253), HEX2EHEX2A_10060265(x_10120252, y_10120253)));
    var syy_10120261 = sum_10060935(HEX2EHEX2A_10060265(y_10120253, y_10120253));
    result_10120254.n = ((n_10120255)|0);
    result_10120254.slope = ((((n_10120255 * sxy_10120259) - (sx_10120256 * sy_10120258)) + (sx_10120256 * sy_10120258)) / ((((n_10120255 * sxx_10120257) - HEX5E_10061056(sx_10120256, 2)) + (sx_10120256 * sx_10120256)) + 1.0000000000000000e-010));
    result_10120254.intercept = 0.0;
    result_10120254.R2 = ((HEX5E_10061056(sxy_10120259, 2) + 1.0000000000000000e-010) / ((sxx_10120257 * syy_10120261) + 1.0000000000000000e-010));
    var residual_10120272 = HEX2D_10060136(y_10120253, HEX2B_10060082(result_10120254.intercept, HEX2A_10060399(result_10120254.slope, x_10120252)));
    result_10120254.residual = nimCopy(null, vector_to_seq_9910014(residual_10120272), NTI9910017);
    result_10120254.residual_sum_squares = sum_10060935(HEX2EHEX5E_10060703(residual_10120272, 2.0000000000000000e+000));
    result_10120254.residual_variance = (result_10120254.residual_sum_squares / ((n_10120255 - 1.0000000000000000e+000) + 1.0000000000000000e-010));
    nimCopy(result_10120254.autocorrelation_function, acf_information_10065170(residual_10120272, 100), NTI10065076);
    result_10120254.slope_variance = (result_10120254.residual_variance / (sxx_10120257 + 1.0000000000000000e-010));
    result_10120254.intercept_variance = 0.0;
    result_10120254.slope_p_value = p_value_of_t_distr_10102061(result_10120254.slope, result_10120254.slope_variance, ((n_10120255)|0));
    result_10120254.intercept_p_value = 0.0;
    result_10120254.slope_width_confidence_interval = ((2.0000000000000000e+000 * Math.sqrt(result_10120254.slope_variance)) * student_t_ppf_95p_10065058((n_10120255 - 1.0000000000000000e+000)));
    result_10120254.slope_confidence_interval[0] = (result_10120254.slope - (5.0000000000000000e-001 * result_10120254.slope_width_confidence_interval));
    result_10120254.slope_confidence_interval[1] = (result_10120254.slope + (5.0000000000000000e-001 * result_10120254.slope_width_confidence_interval));
    result_10120254.intercept_width_confidence_interval = 0.0;
    result_10120254.intercept_confidence_interval[0] = 0.0;
    result_10120254.intercept_confidence_interval[1] = 0.0;

  return result_10120254;
...
function vector_reduced_9880028(v_9880031, sampling_9880032) {
  var result_9880033 = ({length: 0, data: null});
    ...
    result_9880033.data = new Float32Array(1012);
...
function format_value_10105002(result_10105005, result_10105005_Idx, value_10105006, specifier_10105007) {
  ...
  BeforeRet: do {
    ...
    var to_fill_10120040 = ((spec_10105008.minimumWidth - (f_10110002[0] != null ? f_10110002[0].length : 0)) - (sign_10110003 ? 1:0));
    if ((0 < to_fill_10120040)) {
    f_10110002[0] = nimCopy(null, (nsuRepeatChar(48, to_fill_10120040) || []).concat(f_10110002[0] || []), NTI112);
    }
    ...
    var align_10120041 = Tmp1;
    var res_10120042 = align_string_9755222(f_10110002[0], spec_10105008.minimumWidth, align_10120041, spec_10105008.fill);
    if ((ConstSet12[spec_10105008.typ] != undefined)) {
    if (result_10105005[result_10105005_Idx] != null) { result_10105005[result_10105005_Idx] = (result_10105005[result_10105005_Idx]).concat(nsuToUpperAsciiStr(res_10120042)); } else { result_10105005[result_10105005_Idx] = nsuToUpperAsciiStr(res_10120042).slice(); };
    }
    else {
    if (result_10105005[result_10105005_Idx] != null) { result_10105005[result_10105005_Idx] = (result_10105005[result_10105005_Idx]).concat(res_10120042); } else { result_10105005[result_10105005_Idx] = res_10120042.slice(); };
    }
